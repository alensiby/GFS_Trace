...
import {
    irrigationData_withoutcomplete,
    irrigationData_withcomplete,
...
'1': 'Yes'}
  ...
  return (
    ...
    <div className= "subheader">
        ...
        <h1 style={{"color": "black", "margin-bottom":"0px"}}>Irrigation </h1><span>&nbsp;&nbsp;&nbsp;&nbsp;</span>
      ...
      <div className="equipment-table">
        <MaterialTable
          columns={columns}
          data={selected ? irrigationData_withcomplete : irrigationData_withoutcomplete}
          editable={{
